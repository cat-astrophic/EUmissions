# This script performs the data analysis for a paper on the effect of EU NOx emissions standards on EU NOx emissions - ON ROAD EMISSIONS
...
write.csv(stargazer(noxmod1, noxmod2, noxmod3, noxmod4, noxmod5, noxmod6, type = 'text',
          ...
          'C:/Users/User/Documents/Data/EUmissions/regression_results_baseline_ROAD.txt', row.names = FALSE)
write.csv(stargazer(noxmod1, noxmod2, noxmod3, noxmod4, noxmod5, noxmod6,
                    se = list(rse1, rse2, rse3, rse4, rse5, rse6)),
          'C:/Users/User/Documents/Data/EUmissions/regression_results_baseline_ROAD_tex.txt', row.names = FALSE)
write.csv(stargazer(noxmod7, noxmod8, noxmod9, noxmod10, noxmod11, noxmod12, type = 'text',
                    se = list(rse7, rse8, rse9, rse10, rse11, rse12)),
          'C:/Users/User/Documents/Data/EUmissions/regression_results_fullly_specified_ROAD.txt', row.names = FALSE)
